-- Add personalized scheduling function that considers performance and deadline
...
-- Update personalized schedule after practice
...
-- Update trigger to use personalized scheduling
